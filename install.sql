...
@@application/shared_components/navigation/lists/events_and_services.sql
@@application/shared_components/navigation/lists/wizard_progress_list.sql
@@application/shared_components/navigation/lists/sik_navigation.sql
@@application/shared_components/navigation/lists/users.sql
@@application/shared_components/navigation/lists/service_providers.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/luton_campus_map_png.sql
@@application/shared_components/files/university_of_bedfordshire_jpg.sql
@@application/shared_components/files/kiosk_logo_png.sql
@@application/shared_components/files/app_80528_logo_png.sql
@@application/shared_components/files/about_us_thumbnail_aylesbury_jpg.sql
@@application/shared_components/files/about_us_thumbnail_luton_jpg.sql
@@application/shared_components/files/about_us_thumbnail_bedford_jpg.sql
@@application/shared_components/files/mk_campus_entrance_1920_1080_jpg.sql
@@application/shared_components/files/about_us_putteridge_bury_thumbnail_jpg.sql
@@application/shared_components/files/mk_campus_entrance2_jpg.sql
@@application/shared_components/files/about_us_thumbnail_bedford2_jpg.sql
@@application/shared_components/files/about_us_thumbnail_aylesbury2_jpg.sql
@@application/shared_components/files/about_us_thumbnail_luton2_jpg.sql
@@application/shared_components/files/about_us_putteridge_bury_thumbnail2_jpg.sql
@@application/shared_components/files/university_of_bedfordshire_background_jpg.sql
@@application/shared_components/files/uobbackground_jpg.sql
@@application/shared_components/files/newlibrarybackground_jpg.sql
...
@@application/shared_components/user_interface/lovs/bookingstatus.sql
...
@@application/shared_components/user_interface/lovs/eventid_snd_description.sql
...
@@application/shared_components/user_interface/lovs/serviceproviderid_and_name.sql
...
@@application/shared_components/user_interface/lovs/userid_and_fullname.sql
