...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5724990655457402756)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5724990950182402757)
,p_plug_template_id=>wwv_flow_api.id(5724990655457402756)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5724991237276402757)
,p_plug_template_id=>wwv_flow_api.id(5724990655457402756)
,p_name=>'Sub Regions'
