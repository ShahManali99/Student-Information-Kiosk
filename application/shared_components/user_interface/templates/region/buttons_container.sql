...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5724980211711402751)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5724980524157402751)
,p_plug_template_id=>wwv_flow_api.id(5724980211711402751)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5724980887479402752)
,p_plug_template_id=>wwv_flow_api.id(5724980211711402751)
,p_name=>'Sub Regions'
