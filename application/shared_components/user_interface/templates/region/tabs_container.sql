...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5725017068133402770)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5725017383611402770)
,p_plug_template_id=>wwv_flow_api.id(5725017068133402770)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5725017672967402770)
,p_plug_template_id=>wwv_flow_api.id(5725017068133402770)
,p_name=>'Tabs'
