...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5725010295247402767)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5725010541952402767)
,p_plug_template_id=>wwv_flow_api.id(5725010295247402767)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5725010830286402767)
,p_plug_template_id=>wwv_flow_api.id(5725010295247402767)
,p_name=>'Sub Regions'
