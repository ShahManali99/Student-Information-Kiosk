...
,p_alias=>'SIK-NAVIGATION'
,p_step_title=>'SIK Navigation'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'MANALISHAH2899@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20210524101246'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7488364137478239337)
,p_plug_name=>'SIK Navigation'
...
,p_list_id=>wwv_flow_api.id(7558242022012482229)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(5725051275036402786)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7559697404024518955)
