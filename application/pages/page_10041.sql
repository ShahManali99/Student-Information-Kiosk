...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5725199162827403265)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(5725200209200403265)
,p_name=>'Manage User Access'
...
,p_internal_uid=>5725200209200403265
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5725201265442403375)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5725201514919403376)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5725201921357403376)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(5725202615902403377)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'57252027'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5725203551152403378)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5725199162827403265)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5725203949423403378)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5725204388941403378)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(5725199205802403265)
,p_name=>'Refresh on Dialog Close'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(5725199162827403265)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5725204908564403379)
,p_event_id=>wwv_flow_api.id(5725199205802403265)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(5725199162827403265)
);
